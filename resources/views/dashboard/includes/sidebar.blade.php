    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item active"><a href="{{route('admin.dashboard')}}"><i class="la la-mouse-pointer"></i><span
                        class="menu-title" data-i18n="nav.add_on_drag_drop.main">{{trans('dashboard.dashboard')}} </span></a>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.categories')}}"
                                          data-i18n="nav.dash.ecommerce">{{ trans('dashboard.all_categories') }}</a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.categories.create')}}" data-i18n="nav.dash.crypto">{{ trans('dashboard.add_new_category') }} </a>
                    </li>
                </ul>
            </li>
                     <!----------------------------------About us----------------->
            <li class="nav-item"><a href=""><i class="la la-group"></i>
              <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.about_us') }} </span>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('about_us')}}"
                                          data-i18n="nav.dash.ecommerce">{{ trans('dashboard.about_us') }}</a>
                    </li>
                </ul>
            </li>
                   <!------------------------------------About us----------------->
              ...
              <!----------------------------------PoLICY ---------------->
              <li class="nav-item"><a href=""><i class="la la-group"></i>
                     <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.privacy_policy') }} </span>
                     <ul class="menu-content">
                     <li class="active"><a class="menu-item" href="{{route('policy')}}"
                                                 data-i18n="nav.dash.ecommerce">{{ trans('dashboard.privacy_policy') }}</a>
                     </li>
                     </ul>
              </li>
              <!------------------------------------ POLICY----------------->
                     ...
                     <!----------------------------------contact us----------------->
            <li class="nav-item"><a href=""><i class="la la-group"></i>
              <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.contact') }} </span>
                <ul class="menu-content">
                     
                    <li class="active"><a class="menu-item" href="{{route('contact')}}"
                                          data-i18n="nav.dash.ecommerce">{{ trans('dashboard.contact') }}</a>
                    </li>

                    
                     <li class="active"><a class="menu-item" href="{{route('messages.index')}}"
                            data-i18n="nav.dash.ecommerce">{{ trans('dashboard.messages') }}</a>
                     </li>
                   ...
                   <!----------------------------------Followers ----------------->
            <li class="nav-item"><a href=""><i class="la la-group"></i>
              <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.followers') }} </span>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('followers.index')}}"
                                          data-i18n="nav.dash.ecommerce">{{ trans('dashboard.followers') }}</a>
                    </li>
                   ...
                   <!------------------------------------Followers ----------------->
                       ...
                       <!----------------------------------opinions ----------------->
            <li class="nav-item"><a href=""><i class="la la-group"></i>
              <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.opinions') }} </span>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('opinions')}}"
                                          data-i18n="nav.dash.ecommerce">{{ trans('dashboard.opinions') }}</a>
                    </li>
                </ul>
            </li>
                   <!------------------------------------opinions ----------------->
                   ...
                   <!----------------------------------gallary photos ----------------->
            <li class="nav-item"><a href=""><i class="la la-group"></i>
              <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.photos') }} </span>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.gallary.create')}}"
                                          data-i18n="nav.dash.ecommerce">{{ trans('dashboard.photos') }}</a>
                    </li>
                </ul>
            </li>
                   <!------------------------------------gallary photos ----------------->
...
<!--------------------------------------products------------------------------------------->
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.products')}}"
                                          data-i18n="nav.dash.ecommerce"> {{ trans('dashboard.products') }} </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.products.general.create')}}" data-i18n="nav.dash.crypto">{{ trans('dashboard.add_product') }} </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.product_attributes') }}  </span>
                    <span
                        class="badge badge badge-warning  badge-pill float-right mr-2"></span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.attributes')}}"
                            data-i18n="nav.dash.ecommerce">{{ trans('dashboard.product_attributes') }}</a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.attributes.create')}}" data-i18n="nav.dash.crypto">{{ trans('dashboard.add_new_attributes') }} </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.product_attributes_options') }}</span>
                    <span
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.options')}}"
                                          data-i18n="nav.dash.ecommerce">{{ trans('dashboard.product_attributes_options') }}</a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.options.create')}}" data-i18n="nav.dash.crypto">{{ trans('dashboard.add_new_options') }} </a>
                    </li>
                </ul>
            </li>
            <!--------------------------------------products------------------------------------------->
            ...
            <!--------------------------------------blogs------------------------------------------->
              ...
              <li class="nav-item"><a href=""><i class="la la-group"></i>
                     <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.blogs') }}</span>
                     <span
                     class="badge badge badge-danger badge-pill float-right mr-2"></span>
                     </a>
                     <ul class="menu-content">
                            <li class="active"><a class="menu-item" href="{{route('admin.blogs')}}"
                                                 data-i18n="nav.dash.ecommerce">{{ trans('dashboard.all_blogs') }}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.blogs.create')}}" data-i18n="nav.dash.crypto">{{ trans('dashboard.add_new_blog') }} </a>
                            </li>
                            <li><a class="menu-item" href="{{route('comment.index')}}" 
                                   data-i18n="nav.dash.crypto">{{ trans('dashboard.comments') }} </a>
                            </li>
                            <li><a class="menu-item" href="{{route('reply.index')}}" 
                                   data-i18n="nav.dash.crypto">{{ trans('dashboard.replies') }} </a>
                            </li>
                     </ul>
              </li>
              ...
              <!---------------------------------------blogs------------------------------------------>
               ...
               <!--------------------------------------advertises------------------------------------------->
               <li class="nav-item"><a href=""><i class="la la-group"></i>
                     <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.advertises') }}</span>
                     <span
                     class="badge badge badge-danger badge-pill float-right mr-2"></span>
                     </a>
                     <ul class="menu-content">
                            <li class="active"><a class="menu-item" href="{{route('advertise')}}"
                                                 data-i18n="nav.dash.ecommerce">{{ trans('dashboard.all_advertises') }}</a>
                            </li>
              ...
              <!---------------------------------------advertises------------------------------------------>
                <!----------------------------------coupons ----------------->
                <li class="nav-item"><a href=""><i class="la la-group"></i>
                     <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.coupons') }}</span>
                     <span
                         class="badge badge badge-danger badge-pill float-right mr-2"></span>
                 </a>
                 <ul class="menu-content">
                     <li class="active"><a class="menu-item" href="{{route('admin.coupons')}}"
                                           data-i18n="nav.dash.ecommerce">{{ trans('dashboard.all_coupons') }}</a>
                     </li>
                     <li><a class="menu-item" href="{{route('admin.coupons.create')}}" data-i18n="nav.dash.crypto">{{ trans('dashboard.add_new_coupon') }} </a>
                     </li>
                 </ul>
             </li>
                   <!------------------------------------ coupons ----------------->
                    <!----------------------------------carts ----------------->
            <li class="nav-item"><a href=""><i class="la la-group"></i>
              <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.carts') }} </span>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('carts.index')}}"
                                          data-i18n="nav.dash.ecommerce">{{ trans('dashboard.carts') }}</a>
                    </li>
                   ...
                   <!------------------------------------carts ----------------->
                       ...
                       <!----------------------------------Services----------------->
            <li class="nav-item"><a href=""><i class="la la-group"></i>
              <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.servies') }} </span>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('service')}}"
                                          data-i18n="nav.dash.ecommerce">{{ trans('dashboard.servies') }}</a>
                    </li>
                </ul>
            </li>
                   <!------------------------------------Services ----------------->
                   ...
                   <!----------------------------------reservations ----------------->
            <li class="nav-item"><a href=""><i class="la la-group"></i>
              <span class="menu-title" data-i18n="nav.dash.main">{{ trans('dashboard.reservations') }} </span>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('reservations.index')}}"
                                          data-i18n="nav.dash.ecommerce">{{ trans('dashboard.reservations') }}</a>
                    </li>
