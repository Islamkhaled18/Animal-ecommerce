        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{ trans('dashboard.reservations') }}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ trans('dashboard.dashboard') }}</a>
                                </li>
                                <li class="breadcrumb-item active">{{ trans('dashboard.reservations') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ trans('dashboard.reservations') }}</h4>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th>{{ trans('dashboard.animal_type') }} </th>
                                                <th>{{ trans('dashboard.animal_number') }} </th>
                                                <th>{{ trans('dashboard.reservation_date') }} </th>
                                            ...
                                            @isset($reservations)
                                                @foreach($reservations as $reservation)
                                                    <tr>
                                                        ...
                                                        <td>{{$reservation ->animal_number}}</td>
