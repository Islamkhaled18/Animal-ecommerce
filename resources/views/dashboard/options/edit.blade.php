                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.options')}}"> {{ trans('dashboard.product_attributes') }} </a>
                                </li>
                                <li class="breadcrumb-item active"> {{ trans('dashboard.edit_option') }}
                                </li>
                            </ol>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{ trans('dashboard.edit_option') }} </h4>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> {{$option->option_name}} </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="name"
                                                                class="form-control"
                                                                placeholder="  "
                                                                value="{{ $option->getTranslation('option_name', 'ar') }}"
                                                                name="option_name_ar">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="name"
                                                                    class="form-control"
                                                                    placeholder="  "
                                                                    value="{{ $option->getTranslation('option_name', 'en') }}"
                                                                    name="option_name_en">
                                                                ...
                                                                <optgroup label="{{ trans('dashboard.choose_option') }}">
                                                                    @if($attributes && $attributes -> count() > 0)
                                                                        @foreach($attributes as $attribute)
                                                                            ...
                                                                            >{{$attribute ->attributes_name}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </optgroup>
                                                            </select>
