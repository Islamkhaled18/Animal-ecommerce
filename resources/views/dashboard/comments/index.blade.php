        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{ trans('dashboard.comments') }} </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                            
                                <li class="breadcrumb-item active"> {{ trans('dashboard.comments') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th>@lang('dashboard.user_comment')</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <th>{{ $comment->user_email }}</th>
                                                    <th>{{ $comment->user_phone }}</th>
