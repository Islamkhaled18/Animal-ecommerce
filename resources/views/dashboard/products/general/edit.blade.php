                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ trans('dashboard.edit_product') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{ trans('dashboard.edit_product') }}</h4>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> {{ trans('dashboard.edit_product') }} </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{ $product->getTranslation('slug', 'ar') }}"
                                                                   name="slug_ar">
                                                            @error("slug_ar")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                class="form-control"
                                                                placeholder="  "
                                                                value="{{ $product->getTranslation('slug', 'en') }}"
                                                                name="slug_en">
                                                            @error("slug_en")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea  name="short_description_ar" id="short-description"
                                                                    class="form-control"
                                                                    placeholder=""
                                                                    value="{{ $product->getTranslation('short-description', 'ar') }}"
                                                        ></textarea>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea  name="short_description_en" id="short-description"
                                                                    class="form-control"
                                                                    placeholder=""
                                                                    value="{{ $product->getTranslation('short-description', 'en') }}"
                                                        ></textarea>
