                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{ trans('dashboard.price') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">  {{ trans('dashboard.price') }}</h4>
                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">  {{ trans('dashboard.special_price') }}
                                                            </label>
                                                            <input type="number"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{ trans('dashboard.price_type') }}
                                                            </label>
                                                            <select name="special_price_type" class="select2 form-control" multiple>
                                                                <optgroup label="من فضلك أختر النوع ">
                                                                    <option value="percent">{{ trans('dashboard.percent') }}</option>
                                                                    <option value="fixed">{{ trans('dashboard.fixed') }}</option>
                                                                </optgroup>
                                                            </select>
                                                ...
                                                <div class="row" >
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{ trans('dashboard.start_date') }}
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{ trans('dashboard.end_date') }}
                                                            </label>
                                                            <input type="date" id="price"
                                                                   class="form-control"
                                                                   placeholder="  "
