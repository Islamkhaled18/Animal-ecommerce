        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{ trans('dashboard.blogs') }}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">{{ trans('dashboard.dashboard') }}</a>
                                </li>
                                <li class="breadcrumb-item active">{{ trans('dashboard.blogs') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ trans('dashboard.blogs') }}</h4>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th>{{ trans('dashboard.short_description') }} </th>
                                                <th>{{ trans('dashboard.long_description') }}</th>
                                                <th>{{ trans('dashboard.blog_video') }}</th>
                                                <th>{{ trans('dashboard.blog_photo') }}</th>
