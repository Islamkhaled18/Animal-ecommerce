    ...
    <div class="app-content content">
        <div class="content-wrapper">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{ trans('dashboard.photo') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.gallary.images.store.db')}}"
                                              method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i>{{ trans('dashboard.photo') }}</h4>
                                                <div class="form-group">
                                                    <div id="dpz-multiple-files" class="dropzone dropzone-area">
                                                        <div class="dz-message">{{ trans('dashboard.you_can_upload_images_here') }}</div>
                                                    </div>
                                                    <br><br>
                                                </div>
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    <div class="card-text">
                        <p>{{ trans('dashboard.current_images') }}</p>
                    </div>
                </div>
...
@section('script')
    <script>
        ...
        Dropzone.options.dpzMultipleFiles = {
            ...
            ,
            url: "{{ route('admin.gallary.images.store') }}", // Set the url
            success:
